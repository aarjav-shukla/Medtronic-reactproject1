...
const left = () => {
  return (
    <div className="w-2/3 h-150 flex flex-col justify-between">
      <div className="mt-3">
        ...
        <button className="bg-white flex items-center py-3 px-4 mt-12 rounded-full gap-2 font-semibold hover:bg-red-500 duration-200 hover:scale-110 hover:text-white">
          Get in touch{" "}
      ...
      <div className="flex items-center mb-6">
        ...
        <button className="flex bg-gray-500 rounded-full items-center px-4 py-3 font-semibold text-white gap-2  hover:bg-red-500 duration-200 hover:scale-110 hover:text-white  ">
          {" "}
          <span>
